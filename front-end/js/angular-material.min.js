...
! function (e, t, n) {
                ...
                v = {
                    ...
                    disableScrollAround: function (e, n) {
                        function r(e) {
                            ...
                            e = t.element(e || d)[0];
                            var o = 50,
                                r = t.element('<div class="md-scroll-mask">  <div class="md-scroll-mask-bar"></div></div>').css("z-index", o);
                            return e.appendChild(r[0]), r.on("wheel", n), r.on("touchmove", n),
                                function () {
            ...
            function o(e, o, r, i, a, d, c, s, l, m, u) {
                return function () {
                    function p(e) {
                        e = e || {};
                        var t = new b(e || {}),
                            n = !e.skipHide && $.length ? v.hide() : o.when(!0);
    ...
    function () {
        ! function () {
            function e(e) {
                ...
                var c = /^((?:x|data)[\:\-_])/i,
                    s = /([\:\-\_]+(.))/g,
                    l = ["", "xs", "gt-xs", "sm", "gt-sm", "md", "gt-md", "lg", "gt-lg", "xl", "print"],
            ...
            var f, g, b, v = /(-gt)?-(sm|md|lg|print)/g,
                E = /\s+/g,
    ...
    function () {
        function e(e) {
            ...
            var v, E = "default",
                $ = !1;
            return t.extend(m, e), p.$inject = ["$rootScope", "$log"], v = {
                definePalette: o,
                extendPalette: r,
                theme: c,
                setNonce: function (e) {
        ...
        function a(e) {
            ...
            if (r && 0 !== i.length) {
                ...
                M.forEach(function (e) {
                    ...
                    for (var t, n = (e.match(c), 0); t = M[n]; n++)
        ...
        var k = ["50", "100", "200", "300", "400", "500", "600", "700", "800", "900", "A100", "A200", "A400", "A700"],
            T = !1,
            w = null;
    ...
    function () {
        function e(e, n, o, r, i, a) {
            function d(d, s) {
                var l = d.children(),
                    m = s.hasOwnProperty("mdIndeterminate");
                return s.type = "checkbox", s.tabindex = s.tabindex || "0", d.attr("role", s.type), d.on("click", function (e) {
                    ...
                    function (d, s, l, u) {
                        ...
                        var v;
                        u = u || i.fakeNgModel(), r(s), m && (b(), d.$watch(l.mdIndeterminate, b)), l.ngChecked && d.$watch(d.$eval.bind(d, l.ngChecked), u.$setViewValue.bind(u)), p("ngDisabled", "tabindex", {
                            "true": "-1",
                            "false": l.tabindex
                        }), n.expectWithText(s, "aria-label"), e.link.pre(d, {
                            on: t.noop,
                            0: {}
                        }, l, [u]), d.mouseActive = !1, s.on("click", f).on("keypress", h).on("mousedown", function () {
            ...
            function r(e, o, r, d, c, s, l, m, u, p) {
                ...
                function $(e, t) {
                    var n = "alert" === t.$type ? "alertdialog" : "dialog",
                        ...
                        c = "dialogContent_" + (e.attr("id") || r.nextUid());
                    e.attr({
                        role: n,
                        tabIndex: "-1"
                ...
                function n(n, o, r) {
                    if (o) {
                        var i = n[0],
                            ...
                            d = i.querySelector("._md-fab-toolbar-background"),
    ...
    function () {
        function n(e, t) {
            function n(t, n) {
                e(n);
                var o = n[0].querySelector(i),
                    r = n[0].querySelector(a);
            ...
            var r = ["INPUT", "TEXTAREA", "SELECT", "MD-SELECT"],
        ...
        function r(e, n, o, r) {
            function i(i, a, d, c) {
                ...
                function u() {
                    function o() {
                        if (a.addClass("md-no-flex").attr("rows", 1), m) {
                            ...
                            var e = Math.round(Math.round(c() / u)),
                                t = Math.min(e, m);
                    ...
                    function s(e) {
                        p.scrollTop = 0;
                        var t = p.scrollHeight - p.offsetHeight,
                            n = p.offsetHeight + t;
                        p.style.height = n + "px"
                    }
                    ...
                    if (!d.hasOwnProperty("mdNoAutogrow")) {
                        var m = d.hasOwnProperty("rows") ? parseInt(d.rows) : NaN,
                            u = null,
                            p = a[0];
                        if (r(function () {
                                e.nextTick(o)
                ...
                var p = c[0],
                    h = !!c[1],
                    f = c[1] || e.fakeNgModel(),
                    g = t.isDefined(d.readonly),
                    b = e.parseAttributeBoolean(d.mdNoAsterisk);
                if (p) {
        ...
        function n(e, n, o, r) {
            ...
            return {
                ...
                compile: function (a, d) {
                    ...
                    function s(e) {
                        if ("div" == e) $ = t.element('<div class="_md-no-style _md-list-item-inner">'), $.append(a.contents()), a.addClass("_md-proxy-focus");
                        else {
    ...
    function () {
        function e(e, n, o) {
            ...
            function i(r, i, m) {
                ...
                function p() {
                    if (t.isUndefined(m.mdMode)) {
                        var e = t.isDefined(m.value),
                            r = e ? d : c,
                            a = "Auto-adding the missing md-mode='{0}' to the ProgressLinear element";
                ...
                function f(e, o) {
                    if (h()) {
                        var r = n.supplant("translateX({0}%) scale({1},1)", [(o - 100) / 2, o / 100]),
                            i = b({
                                transform: r
                            });
                        t.element(e).css(i)
                ...
                e(i);
                var g, b = n.dom.animator.toCss,
                    v = t.element(i[0].querySelector("._md-bar1")),
                    E = t.element(i[0].querySelector("._md-bar2")),
                    $ = t.element(i[0].querySelector("._md-container"));
    ...
    function () {
        function e(e, o, r, i, a, d) {
            function c(a, c) {
                ...
                var u = o.parseAttributeBoolean(c.multiple),
                    p = u ? "multiple" : "",
                    h = '<div class="_md-select-menu-container" aria-hidden="true"><md-select-menu {0}>{1}</md-select-menu></div>';
                return h = o.supplant(h, [p, a.html()]), a.empty().append(s), a.append(h), c.tabindex || c.$set("tabindex", 0),
                    function (a, c, s, l) {
                        function m() {
                        ...
                        A.$render = function () {
                            ...
                            if (C.setIsPlaceholder(!e), s.mdSelectedText) e = d(s.mdSelectedText)(a);
                            else {
                        ...
                        s.$observe("ngMultiple", function (e) {
                            ...
                            t.isString(e) && (e = !0), E !== n && E === e || (E = e, e ? c.attr({
                                "aria-disabled": "true"
                            }).removeAttr("tabindex").off("click", v).off("keydown", b) : c.attr({
                                tabindex: s.tabindex,
                                "aria-disabled": "false"
                            }).on("click", v).on("keydown", b))
                        }), s.hasOwnProperty("disabled") || s.hasOwnProperty("ngDisabled") || (c.attr({
                            "aria-disabled": "false"
                        }), c.on("click", v), c.on("keydown", b));
                        var O = {
                            role: "listbox",
                            "aria-expanded": "false",
                            "aria-multiselectable": u && !s.ngMultiple ? "true" : "false"
                        };
        ...
        function a(e) {
            function o(e, o, s, l, m, u, p, h, f) {
                ...
                function b(r, i, a) {
                    ...
                    function c() {
                        return m(function (e) {
                            ...
                            t.container.element.css(M.toCss(t.container.styles)), t.dropDown.element.css(M.toCss(t.dropDown.styles)), u(function () {
                                i.addClass("_md-active"), t.dropDown.element.css(M.toCss({
                                    transform: ""
                                })), b(a.focusedNode), e()
                            })
                        })
                    ...
                    function g(e, t, n) {
                        return n.disableParentScroll && !s.getClosest(n.target, "MD-DIALOG") ? n.restoreScroll = s.disableScrollAround(n.element, n.parent) : n.disableParentScroll = !1, n.hasBackdrop && (n.backdrop = s.createBackdrop(e, "_md-select-backdrop _md-click-catcher"), h.enter(n.backdrop, f[0].body, null, {
                                duration: 0
                            })),
                            function () {
                    ...
                    function A() {
                        ...
                        if (!a.isRemoved) {
                            ...
                            return i.addClass("_md-clickable"), a.backdrop && a.backdrop.on("click", t), u.on("keydown", r), u.on("click", m),
                                function () {
                ...
                function E(e, n, o) {
                    var m, u = n[0],
                        ...
                        M = {
                            ...
                            top: d,
                            bottom: v.height - d,
                            right: v.width - d - (s.floatingScrollbars() ? 16 : 0)
                        },
                        y = {
                            top: E.top - M.top,
                            left: E.left - M.left,
                        ...
                        k = g.getElementsByTagName("md-option"),
                        T = g.getElementsByTagName("md-optgroup"),
                        w = c(n, b),
                        _ = r(o.loadingAsync);
                    ...
                    var P = u.getBoundingClientRect(),
                        F = Math.round(100 * Math.min(E.width / N.width, 1)) / 100,
                        B = Math.round(100 * Math.min(E.height / N.height, 1)) / 100;
                    return {
                        container: {
                            element: t.element(u),
                            styles: {
                                left: Math.floor(i(M.left, I, M.right - P.width)),
                                top: Math.floor(i(M.top, O, M.bottom - P.height)),
                                "min-width": L
                            }
                        },
                        dropDown: {
                ...
                var $ = "$mdSelect.show() expected a target element in options.target but got '{0}'!",
                    M = s.dom.animator;
                return {
                    parent: "body",
                    themable: !0,
        ...
        var d = 8,
            c = 0,
            s = t.element('<div class="_md-container"><div class="_md-icon"></div></div>');
    ...
    function () {
            ...
            return {
                ...
                compile: function (e) {
                    ...
                    if (o) {
                        ...
                        return r !== n && e.attr("md-vertical", ""), o.attr("flex") || o.attr("flex", ""),
                            function (e, n, o, r) {
                                function i(e) {
                                ...
                                r.fitInputWidthToTextLength = function (e) {
                                    var t = n.find("md-input-container"),
                                        o = getComputedStyle(t[0]),
                                        r = parseInt(o["min-width"]),
                                        i = 2 * parseInt(o.padding);
        ...
        function o(e, n, o, r, i, a, d, c, s, l) {
            function m(e, n) {
                var r = t.element(e[0].getElementsByClassName("_md-slider-wrapper")),
                    i = n.tabindex || 0;
            ...
            function u(o, m, u, p) {
                ...
                function D(e) {
                    if (!Y()) {
                        ...
                        var t = q(z(oe ? e.pointer.y : e.pointer.x)),
                            n = N(S(t));
                        o.$apply(function () {
                            _(n), H(j(n))
                        })
                ...
                function z(e) {
                    var t = oe ? pe.top : pe.left,
                        n = oe ? pe.height : pe.width,
                        o = (e - t) / n;
                ...
                var V = p[0] || {
                    ...
                    W = p[1],
                    Y = (t.element(r.getClosest(m, "_md-slider-container", !0)), u.ngDisabled ? t.bind(null, c(u.ngDisabled), o.$parent) : function () {
                        return m[0].hasAttribute("disabled")
                    }),
                    K = t.element(m[0].querySelector("._md-thumb")),
                    G = t.element(m[0].querySelector("._md-thumb-text")),
                    X = K.parent(),
                    Q = t.element(m[0].querySelector("._md-track-container")),
                    Z = t.element(m[0].querySelector("._md-track-fill")),
                    J = t.element(m[0].querySelector("._md-track-ticks")),
                    ee = t.element(m[0].getElementsByClassName("_md-slider-wrapper")),
                    te = (t.element(m[0].getElementsByClassName("_md-slider-content")), r.throttle(y, 5e3)),
                    ne = 3,
                    oe = t.isDefined(u.mdVertical),
                    re = t.isDefined(u.mdDiscrete);
                ...
                var ie = t.noop;
                u.ngDisabled && (ie = o.$parent.$watch(u.ngDisabled, E)), d.register(ee, "drag", {
                    horizontal: !oe
                }), o.mouseActive = !1, ee.on("keydown", A).on("mousedown", k).on("focus", T).on("blur", w).on("$md.pressdown", D).on("$md.pressup", I).on("$md.dragstart", O).on("$md.drag", R).on("$md.dragend", L), setTimeout(h, 0);
                var ae = e.throttle(h);
    ...
    function () {
        function e(e, n, o, r) {
            return {
                ...
                replace: !0,
                transclude: !0,
                template: '<div class="md-subheader">  <div class="_md-subheader-inner">    <span class="_md-subheader-content"></span>  </div></div>',
                link: function (i, a, d, c, s) {
                    ...
                    s(i, function (e) {
                        ...
                        var o = '<div class="_md-subheader-wrapper">' + m + "</div>",
                            d = n(o)(i);
    ...
    function () {
        function e(e, n, o, r, i, a) {
            function d(e, d) {
                var s = c.compile(e, d);
                return e.addClass("_md-dragging"),
                    function (e, d, c, l) {
                        function m(t) {
                            f && f(e) || (t.stopPropagation(), d.addClass("_md-dragging"), v = {
                        ...
                        function u(e) {
                            if (v) {
                                ...
                                var t = e.pointer.distanceX / v.width,
                                    n = l.$viewValue ? 1 + t : t;
                        ...
                        var g = t.element(d[0].querySelector("._md-thumb-container")),
                            b = t.element(d[0].querySelector("._md-container"));
                        i(function () {
                    ...
                    transformTemplate: function (e, n) {
                        ...
                        if (o) {
                            ...
                            for (var i = 0; i < r.children.length; i++)
                                if ("MD-TOAST" === r.children[i].nodeName) {
    ...
    function () {
        ...
        o.$inject = ["$$rAF", "$mdUtil", "$parse", "$rootScope", "$window", "$scope", "$element", "$attrs"], o.prototype.register = function (e) {
            ...
            if (!(o === this.scrollOffset || o > this.scrollSize - this.size)) {
                ...
                if (r) {
                    var i = Math.max(0, Math.floor(o / r) - c),
                        a = (this.isHorizontal() ? "translateX(" : "translateY(") + (!this.isHorizontal() || n ? i * r : -(i * r)) + "px)";
    ...
    function () {
        function e(e, n, o, r, i, a, d, c, s) {
            function l(d, l, p) {
                ...
                a(l);
                var k = i.getParentWithPointerEvents(l),
                    T = t.element(l[0].getElementsByClassName("_md-content")[0]),
                    w = t.element(document.body),
                    _ = o.throttle(function () {
                        C()
                    });
    ...
    function () {
        function e(e, o, d, c, s, l, m, u, p, h) {
            ...
            function g() {
                ...
                function n() {
                    var e = ue.scrollContainer.getBoundingClientRect(),
                        t = {};
                    e.right > m.right - i && (t.left = s.right - e.width + "px"), ue.$.scrollContainer.css(t)
                }
                if (!ue) return d.nextTick(g, !1, e);
                var c, s = ue.wrap.getBoundingClientRect(),
                    l = ue.snap.getBoundingClientRect(),
                    m = ue.root.getBoundingClientRect(),
                    u = l.bottom - m.top,
                    h = m.bottom - l.top,
                    f = s.left - m.left,
                    b = s.width,
                ...
                }, u > h && m.height - s.bottom - i < r ? (c.top = "auto", c.bottom = h + "px", c.maxHeight = Math.min(r, s.top - m.top - i) + "px") : (c.top = u - v + "px", c.bottom = "auto", c.maxHeight = Math.min(r, m.bottom + d.scrollTop() - s.bottom - i) + "px"), ue.$.scrollContainer.css(c), d.nextTick(n, !1)
            }
            ...
            function M() {
                ue = {
                    ...
                    root: document.body
                }, ue.li = ue.ul.getElementsByTagName("li"), ue.snap = y(), ue.$ = C(ue)
            }
            ...
            function J() {
                ...
                t.initCustomEvent("input", !0, !0, {
                    value: e.searchText
                }), ue.input.dispatchEvent(t), ue.input.focus()
            }
            ...
            function oe() {
                if (ue.li[0]) {
                    var e = ue.li[0].offsetHeight,
                        t = e * se.index,
                        n = t + e,
                        o = ue.scroller.clientHeight,
                        r = ue.scroller.scrollTop;
    ...
    function () {
        function e(e, t, a, d, c) {
            function s(n, o) {
                ...
                var s = r("md-chips>md-chip-template"),
                    l = r("md-chips>*[md-chip-remove]") || m.remove,
                    u = s || m["default"],
                    p = r("md-chips>md-autocomplete") || r("md-chips>input") || m.input,
                    h = i.find("md-chip");
                return i[0].querySelector("md-chip-template>*[md-chip-remove]") && d.warn("invalid placement of md-chip-remove within md-chip-template."),
                    function (n, r, i, d) {
                        ...
                        var f = d[0];
                        if (s && (f.enableChipEdit = !1), f.chipContentsTemplate = u, f.chipRemoveTemplate = l, f.chipInputTemplate = p, r.attr({
                                "aria-hidden": !0,
                                tabindex: -1
                            }).on("focus", function () {
                                f.onFocus()
        ...
        var n = '      <md-chips-wrap          ng-keydown="$mdChipsCtrl.chipKeydown($event)"          ng-class="{ \'md-focused\': $mdChipsCtrl.hasFocus(), \'md-readonly\': !$mdChipsCtrl.ngModelCtrl || $mdChipsCtrl.readonly}"          class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{\'md-focused\': $mdChipsCtrl.selectedChip == $index, \'md-readonly\': !$mdChipsCtrl.ngModelCtrl || $mdChipsCtrl.readonly}">          <div class="_md-chip-content"              tabindex="-1"              aria-hidden="true"              ng-click="!$mdChipsCtrl.readonly && $mdChipsCtrl.focusChip($index)"              ng-focus="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div ng-if="!$mdChipsCtrl.readonly"               class="_md-chip-remove-container"               md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div class="_md-chip-input-container">          <div ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"               md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>',
            o = '        <input            class="md-input"            tabindex="0"            placeholder="{{$mdChipsCtrl.getPlaceholder()}}"            aria-label="{{$mdChipsCtrl.getPlaceholder()}}"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.onInputFocus()"            ng-blur="$mdChipsCtrl.onInputBlur()"            ng-trim="false"            ng-keydown="$mdChipsCtrl.inputKeydown($event)">',
            r = "      <span>{{$chip}}</span>",
            i = '      <button          class="_md-chip-remove"          ng-if="!$mdChipsCtrl.readonly"          ng-click="$mdChipsCtrl.removeChipAndFocusInput($$replacedScope.$index)"          type="button"          aria-hidden="true"          tabindex="-1">        <md-icon md-svg-icon="md-close"></md-icon>        <span class="_md-visually-hidden">          {{$mdChipsCtrl.deleteButtonLabel}}        </span>      </button>';
    ...
    function () {
        function e(e, t, n) {
            function o(o, r, i) {
                ...
                t(r), d();
                var c = i.alt || i.mdFontIcon || i.mdSvgIcon || r.text(),
    ...
    function () {
        ...
        function r(n, o, r, i, a, d) {
            function c(e) {
                ...
                if (M.test(e) || y.test(e)) return h(e).then(m(e)); - 1 == e.indexOf(":") && (e = "$default:" + e);
                var t = n[e] ? u : p;
                return t(e).then(m(e))
            }
    ...
    function () {
        ...
        e.$inject = ["$scope", "$rootScope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"], e.prototype.init = function () {
            ...
            for (var e = this.getMenus(), t = 0; t < e.length; ++t)
                if (e[t].classList.contains("_md-open")) return t;
            return -1
        }
    }(),
    function () {
    ...
    function () {
        function e(e) {
            ...
            function r(e, o, r, i) {
                var a = i[0],
                    d = i[1] != n,
                    c = t.element('<div class="_md-open-menu-container md-whiteframe-z2"></div>'),
                    s = o.children()[1];
            ...
            function o(e, o, a, d, c, s, l, m, u) {
                ...
                function E(t, o) {
                    ...
                    var s, l = t[0],
                        ...
                        M = o.mdMenuCtrl.positionMode();
                    "target" != M.top && "target" != M.left && "target-right" != M.left || (s = a(), s && (s = s.firstElementChild || s, s = s.querySelector("[md-menu-align-target]") || s, E = s.getBoundingClientRect(), $ = {
                    ...
                    var w = Math.round(100 * Math.min(b.width / l.offsetWidth, 1)) / 100,
                        _ = Math.round(100 * Math.min(b.height / l.offsetHeight, 1)) / 100;
                    return {
                        top: Math.round(y.top),
                        left: Math.round(y.left),
                        transform: o.alreadyOpen ? n : e.supplant("scale({0},{1})", [w, _]),
                        transformOrigin: C
                    }
                }
                var $ = e.dom.animator;
        ...
        function e(e, n, o, r, i, a, d) {
            function c(d, c, l) {
                ...
                function v() {
                    if (!$) {
                        var t = i.now(),
                            n = o.rotationDurationIndeterminate,
                            r = u(d.mdDiameter) / 2;
                        r = " " + r + ", " + r, e(function s(a) {
                            var d = a || i.now(),
                                c = d - t,
                                l = o.easingPresets.linearEase(c, 0, 360, n);
                ...
                var $, M = t.element(c[0].querySelector("svg")),
                    y = t.element(c[0].querySelector("path")),
                    C = o.startIndeterminate,
                    A = o.endIndeterminate,
                    k = 0,
                    T = 0;
                r(c), d.mdMode === g && v(), d.$watchGroup(["value", "mdMode"], function (e, t) {
                    var n = e[1];
                    if (n !== f && n !== g && (n = g, l.$set("mdMode", n)), n === g) v();
                    else {
                        var o = m(e[0]);
                ...
                compile: function (e, n) {
                    if (e.attr({
                        ...
                        var o = t.isDefined(n.value),
                            r = o ? f : g,
                            a = "Auto-adding the missing md-mode='{0}' to the ProgressCircular element";
    ...
    function () {
        function e(e, o, r, i, a, d, c, s, l, m) {
            ...
            function H() {
                var e, t, n = me.canvas.clientWidth,
                    o = n + se.offsetLeft;
            ...
            function L(e) {
                if (!pe) {
                    var t = se.selectedIndex,
                        n = se.tabs.splice(e.getIndex(), 1)[0];
            ...
            function Q() {
                var e = se.tabs[se.selectedIndex],
                    t = se.tabs[se.focusIndex];
            ...
            function re() {
                ...
                var e = me.contents[se.selectedIndex],
                    t = e ? e.offsetHeight : 0,
                    r = me.wrapper.offsetHeight,
                    i = t + r,
            ...
            function ce(e, n) {
                var o = {
                    colorElement: t.element(me.inkBar)
                };
                a.attach(e, n, o)
            }
            var se = this,
